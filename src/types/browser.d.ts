...
declare namespace browser.browserAction {
  ...
  function setBadgeTextColor(details: { color: string | ColorArray; tabId?: number }): void;
  function setBadgeTextColor(details: { color: string | ColorArray; windowId?: number }): void;
...
declare namespace browser.windows {
  ...
  function getCurrent(getInfo?: { populate?: boolean; windowTypes?: WindowType[] }): Promise<browser.windows.Window>;
  ...
  function getAll(getInfo?: { populate?: boolean; windowTypes?: WindowType[] }): Promise<browser.windows.Window[]>;
